 ...
 * @file
 */
#ifndef MCA_BTL_FFTCP_H
#define MCA_BTL_FFTCP_H
...
extern opal_event_base_t *mca_btl_fftcp_event_base;
...
extern opal_list_t mca_btl_fftcp_ready_frag_pending_queue;
extern opal_mutex_t mca_btl_fftcp_ready_frag_mutex;
extern int mca_btl_fftcp_pipe_to_progress[2];
extern int mca_btl_fftcp_progress_thread_trigger;
...
#define MCA_BTL_TCP_ACTIVATE_EVENT(event, value)                                          \
    do {                                                                                  \
        if (0 < mca_btl_fftcp_progress_thread_trigger) {                                    \
            ...
            (void) opal_fd_write(mca_btl_fftcp_pipe_to_progress[1], sizeof(opal_event_t *), \
                                 &_event);                                                \
        } else {                                                                          \
...
struct mca_btl_fftcp_component_t {
    ...
    struct mca_btl_fftcp_module_t **tcp_btls; /**< array of available BTL modules */
...
typedef struct mca_btl_fftcp_component_t mca_btl_fftcp_component_t;

OPAL_DECLSPEC extern mca_btl_fftcp_component_t mca_btl_fftcp_component;

/**
 * BTL Module Interface
 */
struct mca_btl_fftcp_module_t {
...
typedef struct mca_btl_fftcp_module_t mca_btl_fftcp_module_t;
extern mca_btl_fftcp_module_t mca_btl_fftcp_module;
 ...
 */
extern mca_btl_base_module_t **mca_btl_fftcp_component_init(int *num_btl_modules,
...
extern int mca_btl_fftcp_finalize(struct mca_btl_base_module_t *btl);
...
extern int mca_btl_fftcp_add_procs(struct mca_btl_base_module_t *btl, size_t nprocs,
...
extern int mca_btl_fftcp_del_procs(struct mca_btl_base_module_t *btl, size_t nprocs,
...
extern int mca_btl_fftcp_send(struct mca_btl_base_module_t *btl,
...
extern mca_btl_base_descriptor_t *mca_btl_fftcp_alloc(struct mca_btl_base_module_t *btl,
...
extern int mca_btl_fftcp_free(struct mca_btl_base_module_t *btl, mca_btl_base_descriptor_t *des);
...
extern void mca_btl_fftcp_dump(struct mca_btl_base_module_t *btl,
